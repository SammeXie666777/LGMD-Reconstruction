...
%% Step 5: Assign the true root ID 
    true_root_id = 1174;
...
% Visualize:
visualize_swc_interactive(swc_data_sorted, 'Tip');
swc_data_sorted (:,2) = 0;
...
swcfilename = 'Complete_Swc_Data_NodesRemoved.swc';
save_to_swc(swc_data_sorted, swcfilename)

%% Turn the swc file into hoc file directly
TypeName = {'soma','Axon','FieldA','FieldB','FieldC','Cellbody','FieldD'}; %[1 - 7]
output_hoc = 'LGMD_Complete_Construction_NodesRemoved.hoc';
